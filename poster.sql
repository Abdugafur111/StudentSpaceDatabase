...
VALUES ('abdu@gmail.com', 1234567, '$2a$10$oFYxiG619kOlagO36e7Rq.YL673o/rCoyDN227PpAYK5t1CRY.8Ti', '2021 Dell Way', '1997-01-13', 'Abdugafur', 'Dalerzoda', 'ROLE_ADMIN');

INSERT INTO USERS (email, student_id, password, address, date_of_birth, first_name, last_name, role)
VALUES ('jagi@gmail.com', 9876543, '$2a$10$oFYxiG619kOlagO36e7Rq.YL673o/rCoyDN227PpAYK5t1CRY.8Ti', '2021 American Way', '1991-09-23', 'Jagi', 'Singh', 'ROLE_STUDENT');

INSERT INTO USERS (email, student_id, password, address, date_of_birth, first_name, last_name, role)
VALUES ('quang@gmail.com', 5432167, '$2a$10$oFYxiG619kOlagO36e7Rq.YL673o/rCoyDN227PpAYK5t1CRY.8Ti', '2021 Broadway', '1990-05-10', 'Quag', 'Le', 'ROLE_STUDENT');
...
-- Post 1 by abdu
INSERT INTO POST_COMMENTS (post_id, post_comment_user, post_comment_text) VALUES (1, 'jagi@gmail.com', '👍 Good luck in your final year!');
INSERT INTO POST_COMMENTS (post_id, post_comment_user, post_comment_text) VALUES (1, 'quang@gmail.com', '🙌 You got this! Make the most of your senior year!');


-- Post 2 by jagi
INSERT INTO POST_COMMENTS (post_id, post_comment_user, post_comment_text) VALUES (2, 'abdu@gmail.com', '👏 "To Kill a Mockingbird" is such a powerful book. It really makes you think.');
INSERT INTO POST_COMMENTS (post_id, post_comment_user, post_comment_text) VALUES (2, 'quang@gmail.com', '📚 One of my favorite reads too!');

-- Post 3 by quang
INSERT INTO POST_COMMENTS (post_id, post_comment_user, post_comment_text) VALUES (3, 'abdu@gmail.com', '🏀 Can\t wait to see you on the court! Go team!');
INSERT INTO POST_COMMENTS (post_id, post_comment_user, post_comment_text) VALUES (3, 'jagi@gmail.com', '🔥 Let\s bring home the championship!');

-- Insert post likes
INSERT INTO POST_LIKES (post_id, post_liked_user) VALUES (1, 'jagi@gmail.com');
INSERT INTO POST_LIKES (post_id, post_liked_user) VALUES (1, 'quang@gmail.com');
...
INSERT INTO POST_LIKES (post_id, post_liked_user) VALUES (3, 'jagi@gmail.com');
